...
# print(include_files)
# Define the list of image files you want to include
image_files = ['resized_background.jpeg']  # Add all your image filenames here

# Create a list of tuples for include_files
include_files = [(file, file) for file in image_files]
